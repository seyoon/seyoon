function drag(elToDrag, elTarget, event, fCallbackSuccess, fCallbackFail, fCallbackReportObjInfo) {
	...
	elToDrag.parentNode.appendChild(elClone);
	...
	function upHandler(e) {
		...
		if(!bEventPairFlag){
			...
			elToDrag.parentNode.removeChild(elClone);
